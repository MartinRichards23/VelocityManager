...
void drffti(int n, double *wsave, int *ifac)
{
...
void dcosqi(int n, double *wsave, int *ifac)
{
...
L105:
	...
	for(k=0;k<l1;k++)
	{
		ch[t1]=-cc[t2]; /* ido-1 + k*ido + l1*ido */
		ch[t1-1]=cc[t3];
		t1+=ido<<1;
		t2+=ido;
		t3+=ido;
...
STIN void dradf4(int ido, int l1, double *cc, double *ch, double *wa1, double *wa2, double *wa3)
{
	...
	for(k=0;k<l1;k++)
	{
		...
		for(i=2;i<ido;i+=2)
		{
			...
			cr2=wa1[i-2]*cc[(t3+=t0)-1]+wa1[i-1]*cc[t3];
			ci2=wa1[i-2]*cc[t3]-wa1[i-1]*cc[t3-1];
			cr3=wa2[i-2]*cc[(t3+=t0)-1]+wa2[i-1]*cc[t3];
			ci3=wa2[i-2]*cc[t3]-wa2[i-1]*cc[t3-1];
			cr4=wa3[i-2]*cc[(t3+=t0)-1]+wa3[i-1]*cc[t3];
...
STIN void dradfg(int ido, int ip, int l1, int idl1, double *cc, double *c1, double *c2, double *ch, double *ch2, double *wa)
{
	static double tpi=6.28318530717958647692528676655900577;
...
void drfftf(int n, double *r, double *wsave, int *ifac)
{
	if(n==1)return;
...
void dcosqf(int n, double *x, double *wsave, int *ifac)
{
...
STIN void dradbg(int ido, int ip, int l1, int idl1, double *cc, double *c1, double *c2, double *ch, double *ch2, double *wa)
{
	static double tpi=6.28318530717958647692528676655900577;
...
void drfftb(int n, double *r, double *wsave, int *ifac)
{
	if (n == 1)return;
...
void dcosqb(int n, double *x, double *wsave, int *ifac)
{
